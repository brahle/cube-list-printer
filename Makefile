...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=cube_list_printer -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > cube_list_printer/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add cube_list_printer/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "cube_list_printer = 'cube_list_printer.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run cube_list_printer'"
